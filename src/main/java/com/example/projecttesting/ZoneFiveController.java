...
public class ZoneFiveController implements Initializable {
    ...
    Image chiondoxaImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("Chionodoxa.jpg")));
    ...
    public void buttonSearch(ActionEvent e) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("PlantPageZone5.fxml"));
        root = loader.load();
        PlantPageZone5 plantPage = loader.getController();
        if (inputSearch.equalsIgnoreCase("Aconite")) {
            ...
            plantPage.displayPicture(chiondoxaImage);
        }
            ...
            FXMLLoader wrong = new FXMLLoader(getClass().getResource("ZoneFiveScreen.fxml"));
